...
public class ModBlocks {
    ...
    public static final Block ANCIENT_DEBRIS = new AncientDebris("ancient_debris", CreativeTabs.BUILDING_BLOCKS, Material.ROCK);
    public static final Block SMITHING_TABLE = new SmithingTable("smithing_table", CreativeTabs.DECORATIONS, Material.WOOD);
    public static final Block NETHERITE_BLOCK = new NetheriteBlock("netherite_block", CreativeTabs.BUILDING_BLOCKS, Material.ROCK);
}
