...
public class ModMaterials {
    ...
    public static final ItemArmor.ArmorMaterial ARMOR_NETHERITE_ALLOY = Objects.requireNonNull(EnumHelper.addArmorMaterial("armor_netherite_alloy", "netheriteroad:netherite", 37, new int[]{3, 6, 8, 3}, 15, ModSounds.NETHERITE_ARMOR_SOUND, 3)).setRepairItem(new ItemStack(ModItems.NETHERITE_INGOT));
}
